...
describe('export uploads', () => {
  it('should be able to export uploads', async () => {
    // spy - monitorar a função exportUploads para verificar se ela foi chamada corretamente
    // stub - substituir a função exportUploads por uma implementação falsa para testar o
    // comportamento do código que depende dela
